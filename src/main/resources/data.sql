...
MERGE INTO films (id, name, description, duration, release_date, mpa_id) KEY(id)
VALUES
    (1, 'TestFilm1', 'Description1', 120, '2021-01-01', 1),
    (2, 'TestFilm2', 'Description2', 90, '2022-02-02', 2);